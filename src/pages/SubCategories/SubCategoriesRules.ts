export const SubCategoriesRules = {
  name: {
    required: 'Sub Categories is required',
    maxLength: { value: 50, message: 'Sub Categories name should not exceed 50 characters' },
    pattern: {
      value: /^[a-zA-Z0-9\s]*$/,
      message: 'Sub Categories name should only contain alphanumeric characters and spaces',
    },
  },
  title: {
