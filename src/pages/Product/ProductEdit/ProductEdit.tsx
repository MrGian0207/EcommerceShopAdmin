...
function ProductEdit(): JSX.Element {
  ...
  const [imagePreviewEditwArray, setImagePreviewEditArray] = useState<string[]>(
    [],
  );
  ...
  const GenderOptionData: string[] = ['None', 'Men', 'Women', 'Kids', 'Others'];
                ...
                <div className={cx('feature-product')}>
                  <div className={cx('toggle-box')}>
                    <input
                      ...
                      checked={featureProduct === 'active' ? true : false}
                      type="checkbox"
                      id="toggle"
                    />
                    <label
                    ...
                    variantArray.map((variant, variantIndex) => (
                      <div key={`${variant.variantName}-${variantIndex}`}>
                        <VariantItems
                          ...
                          setToggleModalVariantEdit={setToggleModalVariantEdit}
                          savedImageVariantArray={savedImageVariantArray}
                          setImagePreviewEditArray={setImagePreviewEditArray}
                          variantId={idVariantArray[variantIndex] as string}
                          setIdVariantArray={setIdVariantArray}
                          setIdVariantDeletedArray={setIdVariantDeletedArray}
                        />
                      </div>
                    ))}
                </div>
