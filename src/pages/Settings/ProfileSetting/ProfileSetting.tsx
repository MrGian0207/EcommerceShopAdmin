...
function ProfileSetting() {
  ...
  const [isEmailAddressUserTouched, setIsEmailAddressUserTouched] = useState<boolean>(false)
  ...
  const handleSubmit = async () => {
    if (name && emailAddress && phone) {
      ...
      formData.append(
        'id',
        localStorage.getItem('id_user') ? (localStorage.getItem('id_user') as string) : ''
      )
    ...
    <div className={cx('ProfileSetting')}>
      ...
      <div className={cx('user-image')}>
        ...
        >
          ...
          />
          <img
            src={resizedImageUrl || imageUrl ? resizedImageUrl : images.userDefaults}
            alt="Avatar"
          />
          ...
          <div>
            <div className={cx('user-name')}>
              ...
              <input
                value={name}
                onChange={(e) => {
                  handleInputChange(e, setName, 'nameUser', setIsNameUserTouched)
                }}
                id="user-name"
                type="text"
              />
            ...
            {isNameUserTouched && checkError(Errors).nameUser && (
              <ErrorInput nameError={checkError(Errors).nameUser as string} />
            )}
          </div>
          <div>
            ...
            {isEmailAddressUserTouched && checkError(Errors).emailAddressUser && (
              <ErrorInput nameError={checkError(Errors).emailAddressUser as string} />
            )}
          </div>
        </div>
          ...
          <div>
            <div className={cx('user-phone')}>
              ...
              <input
                value={phone}
                onChange={(e) => {
                  handleInputChange(e, setPhone, 'phoneUser', setIsPhoneUserTouched)
                }}
                id="user-phone"
                type="text"
              />
            ...
            {isPhoneUserTouched && checkError(Errors).phoneUser && (
              <ErrorInput nameError={checkError(Errors).phoneUser as string} />
            )}
          </div>
          <div>
