...
function ChangePassword(): JSX.Element {
   ...
   const [isOldPasswordTouched, setIsOldPasswordTouched] =
      useState<boolean>(false);
   const [isNewPasswordTouched, setIsNewPasswordTouched] =
      useState<boolean>(false);
   const [isConfirmNewPasswordTouched, setIsConfirmNewPasswordTouched] =
      useState<boolean>(false);
         ...
         <div className={cx('change-passord-form')}>
            <div>
               ...
               {isOldPasswordTouched && checkError(Errors).oldPassword && (
                  <ErrorInput
                     nameError={checkError(Errors).oldPassword as string}
                  />
               )}
            </div>
            <div>
               ...
               {isNewPasswordTouched && checkError(Errors).newPassword && (
                  <ErrorInput
                     nameError={checkError(Errors).newPassword as string}
                  />
               )}
            </div>
            <div>
               ...
               {isConfirmNewPasswordTouched &&
                  checkError(Errors).confirmPassword && (
                     <ErrorInput
                        nameError={checkError(Errors).confirmPassword as string}
                     />
                  )}
            </div>
